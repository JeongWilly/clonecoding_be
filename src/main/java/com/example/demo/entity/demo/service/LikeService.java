package com.example.demo.entity.demo.service;

import com.example.demo.entity.demo.entity.Articles;
import com.example.demo.entity.demo.entity.Like;
import com.example.demo.entity.demo.entity.User;
import com.example.demo.entity.demo.repository.ArticlesRepository;
import com.example.demo.entity.demo.repository.LikeRepository;
import com.example.demo.entity.demo.repository.UserRepository;
...
//    }
    ...
    public Boolean likeArticles(Long articlesId) {
...
//        if (!likeRepository.findByArticlesAndUsername(target, username)) {
